...
class W_Shelf():
    ...
    def add_cell(self, cell):
        ...
        if self.last_cell == cell:
            self.shelf_cells.insert(0,cell)
            return
        current_cell = self.last_cell
        while current_cell.cell_bellow:
            current_cell = current_cell.cell_bellow
        current_cell.cell_bellow = cell
        cell.cell_above = current_cell
        self.first_cell = cell
        self.shelf_cells.insert(0,cell)
